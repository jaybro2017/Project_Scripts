        ...
        while response == '':
         try:
           ...
           return cls.new_from_response(response)
            ...
            print (err)
            print ("err HTTP ERRORS")
            if hasattr(err,'code')and 500 <=err.code < 600:
                      continue
                      return
                      if hasattr(err,'code') >=400:
                                continue
                                return
            #return 0
            #pass
            ...
            #pass
            #sys.exit(1)
         except requests.exceptions.ConnectTimeout as errr:
            print (errr)
            print ("C1")
            pass
            return
         ...
         except requests.exceptions.TooManyRedirects as errrr:
            print (errrr)
            ...
            #return 0
            #pass
         except requests.exceptions.RequestException as errrrr:
            print (errrrr)
            ...
            #return 0
            #pass
         except requests.exceptions.ReadTimeout as eer:
             print (eer)
             print ("C3")
             pass
             return
